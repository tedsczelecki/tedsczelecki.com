...
const SocialIcons = ({
  ...
  return (
    <div className="social-icons">
      <a
        className="social-icons__angellist"
        href={angellist}
      ...
      <a
        className="social-icons__github"
        href={github}
        rel="noopener noreferrer"
        target="_blank"
      >
